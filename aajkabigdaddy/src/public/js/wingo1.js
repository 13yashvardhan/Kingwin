...
$.ajax({
   ...
   // Function to set style properties for elements
...
if (firstGame && firstGame.stage === list_orders[0].period) {
    ...
    modal.style.backgroundColor = "rgba(0, 0, 0, 0.5)"; // Darken background
    ...
    // Set header text
    myModalheader.innerHTML = "<span style='color: #8f5206; font-family: Roboto, sans-serif;'>"+ (firstGame.get == 0 ? "Try Again" : "Congratulations") + "</span>";

    // Set bonus text and amount with increased font size
    myModal_result.innerHTML = "<div style='font-size: small; color: #8f5206; font-family: Roboto, sans-serif;'>Bonus</div><div id='bonusAmount' style='font-size: large; color: #8f5206; font-family: Roboto, sans-serif; margin-top: 2px;'>₹" + (firstGame.get == 0 ? firstGame.money : firstGame.get) + "</div>";

    // Set period text
    myModal_result_Period.innerHTML = "<span style='color: #8f5206; font-family: Roboto, sans-serif;'>Period: 1min " + firstGame.stage + "</span>";
    ...
    if (firstGame.result == 0) {
            color = "Red + Violet";
            dynamicClass = "btn-boox-rv"
        } else if (firstGame.result == 5) {
            color = "Green + Violet";
            dynamicClass = "btn-boox-gv"
        } else if (firstGame.result % 2 == 0) {
            color = "Red";
            dynamicClass = "btn-boox-r"
        } else {
            color = "Green";
            dynamicClass = "btn-boox"
    }

        lottery_result.innerHTML = "Lottery Result:<span class='" + dynamicClass + "'>" + " " + color + " " + "</span><span class='" + dynamicClass + "'>" + firstGame.result + "</span><span class='" + dynamicClass + "'>" + type + "</span>";

    // Set style properties for bonus amount
    setStyle(document.getElementById("bonusAmount"), {
